...
namespace jaytwo.CommonLib.Drawing
{
    public static class DrawingUtilities
    {
		...
		public static Size? ParseSize(string value)
		{
			if (value != null)
			{
				...
				if (match.Success)
				{
					var square = match.Groups["SQUARE"].Value.TryParseInt32();
					var width = match.Groups["W"].Value.TryParseInt32();
					var height = match.Groups["H"].Value.TryParseInt32();
